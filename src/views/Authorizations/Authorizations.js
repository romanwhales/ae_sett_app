            ...
            <div className="animated fadeIn">
                ...
                <Row>
                    <Col>
                        ...
                        <FormattedMessage id="Success: Authorized Successfully!" defaultMessage="Success: Authorized Successfully!"/>
                        </Alert>:null}
                    </Col>
                </Row>
                <Row>
                                    ...
                                    ? [
                                        this.props.pendingAuthorizations.payload.length > 0 ? this.props.pendingAuthorizations.payload ? this.props.pendingAuthorizations.payload.map((item,index) => {
                                            ...
                                            return(
                                                ...
                                                {/* <td>{parsedPayload != null ?parsedPayload.amount.toLocaleString():null}</td> */}
                                                <td>{item.maker}</td>
                                                <td>
                                                    {/* <Moment>{item.at}</Moment> */}
                                                    {item.at.toString()}
                                                </td>
                                                <td><Button className="btn btn-danger" size="sm" onClick={e=>this.deleteRequest(item.id,item.action)}> <i class="fa fa-trash" aria-hidden="true"></i>&nbsp;Delete</Button></td>
                                                {/* <td> 
