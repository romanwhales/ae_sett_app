                ...
                <Row>
                    <Col xs="12">
                        <Field name="affiliate.id" label="Affiliate" component={renderSelectField} validate={required}>
                            ...
                            { props.affiliates.affiliateListUnPaginated?props.affiliates.affiliateListUnPaginated.map((item,index) => <option value={item.id} key={index}>{item.name}</option>):'' }
                        </Field>
                    </Col>
                </Row>
            </ModalBody>
