...
import {  Col, Row, Table, Button, Form, FormGroup, Input, Label ,FormFeedback} from 'reactstrap';
const required = value => (value || typeof value === 'boolean' ? undefined : 'Required')
...
const EditFileDefinitionForm = (props) => {
...
const afterSubmit = (result, dispatch) =>
  dispatch(reset('editfiledefinitionform')
);
...
export default reduxForm({
    form: 'editfiledefinitionform', // a unique identifier for this form
    onSubmitSuccess: afterSubmit,
    validate,
  })(EditFileDefinitionForm);