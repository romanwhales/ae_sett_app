                            ...
                            <CardBody>
                                    ...
                                    <Row>
                                        <Col xs="12">
                                            <FormGroup row>
                                                <Col md="2">
                                                {/* <Label>Allow Manual Posting</Label> */}
                                                ...
                                                <Field
                                                    ...
                                                    />{' '}
                                                    <Label className="form-check-label" check htmlFor={`true ${index}`}>True</Label>
                                                ...
                                                <FormGroup check inline>
                                                    <Field
                                                        ...
                                                        />{' '}
                                                        <Label className="form-check-label" check htmlFor={`false ${index}`}>False</Label>
