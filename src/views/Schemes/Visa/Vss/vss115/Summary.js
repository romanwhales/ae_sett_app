...
import {fetchVss115Summary} from '../../../../../actions/filesets';
import Pagination2 from "react-js-pagination";


class Vss115DailySummary extends Component{
    constructor(props){
        super(props);
        this.state = {
            showModal:false,
    ...
    componentWillMount=()=>{
        ...
        this.props.fetchVss115Summary(this.props.match.params.date,0)
    ...
    handlePageChange = (pageNumber) => {
        ...
        this.props.fetchVss115Summary(this.props.match.params.date,pageNumberParam)
            ...
            <div className="animated fadeIn">
                ...
                <Row>
                    <Col>
                        ...
                        {this.props.fileSets.vss115SummaryError?<Alert color="danger" isOpen={this.state.vss115SummaryErrorVisible} toggle={this.onDismissVss115SummaryErrorVisibleAlert}>
                            Error!: {this.props.fileSets.vss115SummaryError.data.message}
                        </Alert>:null}
                    </Col>
                </Row>
                <Row>
                    <Col>
                        ...
                        <CardBody>
                            ...
                            <tbody>
                                ...
                                {  this.props.fileSets.vss115Summary
                                    ? [
                                        this.props.fileSets.vss115Summary.data.content.length > 0 ? this.props.fileSets.vss115Summary.data? this.props.fileSets.vss115Summary.data.content.map((item,index) => (
                                            <tr key={index+1}>
                                                <td>{index+1}</td>
                                ...
                                {this.props.fileSets.vss115Summary?<nav>
                                <Pagination2
                                    activePage={this.state.activePage}
                                    itemsCountPerPage={20}
                                    totalItemsCount={this.props.fileSets.vss115Summary?this.props.fileSets.vss115Summary.data.totalElements:null}
...
const mapStateToProps = (state) => {
  ...
  export default connect(mapStateToProps,mapDispatchToProps)(Vss115DailySummary );