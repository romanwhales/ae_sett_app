...
import {fetchVisaPostingReport} from '../../../../actions/reports';
...
class IssuerVisaReports extends Component{
    constructor(props){
        super(props);
        this.state = {
            showModal:false,
    ...
    //    this.props.fetchBatchesSummary('2018-04-12');
        ...
        //  console.log('Date is ',date);
         ...
         this.props.fetchVisaPostingReport('2018-01-01','2019-12-12',0,'ALL','ALL');
    ...
    handleChange(date) {
      ...
      onSubmit=(values)=>{
        ...
        this.props.fetchVisaPostingReport(startDate,endDate,0,values.posting.value,values.validation.value);
    }
            ...
            <div className="animated fadeIn">
                ...
                <Row>
                    <Col>
                        <Card>
                        <CardHeader>
                            <i className="fa fa-cc-visa"></i><FormattedMessage id="Visa Reports" defaultMessage="Visa Reports"/>
                        </CardHeader>
                        <CardBody>
                            {/* {
                            ...
                            <thead className="thead-light">
                                <tr>
                                    ...
                                    <th><FormattedMessage id="Summary Acquirer Amount" defaultMessage="Summar Acquier Amount"/></th>
                            ...
                            {  this.props.reports.visaReport
                                    ? [
                                        this.props.reports.visaReport.content.length > 0 ?this.props.reports.visaReport ? this.props.reports.visaReport.content.map((item,index) => (
                                            <tr key={index+1}>
                                                <td>{item.filename}</td>
...
const mapStateToProps = (state) => {
  ...
  const mapDispatchToProps= (dispatch) => {
    return bindActionCreators({
        fetchVisaPostingReport
    },dispatch)
  }
  
  export default connect(mapStateToProps,mapDispatchToProps)(IssuerVisaReports); 