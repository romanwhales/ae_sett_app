...
import {fetchVisaIssuerSummary,fetchVisaIssuerSummaryStats} from '../../../../actions/filesets';
...
class VisaIssuerSummary extends Component {
    constructor(props){
        super(props);
        this.state ={
            modal:false,
    ...
    fileDefinitionId = ''
  componentDidMount(){
      this.props.fetchVisaIssuerSummary(this.props.match.params.date);
      this.props.fetchVisaIssuerSummaryStats(this.props.match.params.date);
  }
  ...
  render() {
    ...
    return (
      <div className="animated fadeIn">
        {this.props.fileSets.visaIssuerSummaryError?<Alert color="danger" isOpen={this.state.fileSetUpdatedAlert} toggle={this.onDismissFileSetUpdatedSuccessAlert}>
            {this.props.fileSets.visaIssuerSummaryError.data.message}
        </Alert>:null} 
        {this.props.fileSets.visaIssuerSummaryStats?<Row>
          <Col>
          ...
          <Col lg={12}>
            ...
            <Card>
              ...
              {/* <strong> {this.props.fileSets.fileSetBatchDetail? <React.Fragment> 
                ...
                <strong>
                Visa Issuer {this.props.match.params.date} Summary</strong>
                <div className="card-header-actions">
                {this.props.fileSets.visaIssuerSummary?<a href="" onClick={e => this.downloadPostingFile(this.props.match.params.fileId)} href="javascript:;" download={""+1+".csv"}><i class="fa fa-download" aria-hidden="true" ></i></a>:''}
                </div>
              </CardHeader>
              ...
              <CardBody>
                <Table hover bordered striped responsive size="sm">
                    ...
                    {this.props.fileSets.visaIssuerSummary
                        ? [
                            this.props.fileSets.visaIssuerSummary.data.length > 0 ?   this.props.fileSets.visaIssuerSummary.data.map((item,index) => (
                                    <React.Fragment>
                                    <tr >
...
const mapDispatchToProps= (dispatch) => {
  return bindActionCreators({
    fetchVisaIssuerSummary,
    fetchVisaIssuerSummaryStats
  },dispatch)
}

export default connect(mapStateToProps,mapDispatchToProps)(VisaIssuerSummary);
