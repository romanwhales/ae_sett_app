...
import {fetchInterAffiliateIssuerSummary,downloadT464PostingFile} from '../../../../actions/filesets';
...
class InterAffiliateIssuerSummary extends Component {
    constructor(props){
        super(props);
        this.state ={
            modal:false,
  ...
  componentDidMount(){
    ...
    this.props.fetchInterAffiliateIssuerSummary(this.props.match.params.date);
  ...
  render() {
    ...
    return (
      <div className="animated fadeIn">
        ...
        {/* {this.props.fileSets.interAffiliateAcquirerSummary?<Row>
          <Col>
          ...
          <Col lg={12}>
            ...
            <Card>
              <CardHeader>
                ...
                <strong>
                InterAffiliate Issuer {this.props.match.params.date} Summary</strong>
              ...
              <CardBody>
                <Table hover bordered striped responsive size="sm">
                    ...
                    {this.props.fileSets.interAffiliateIssuerSummary
                        ? [
                            this.props.fileSets.interAffiliateIssuerSummary.data.length > 0 ?   this.props.fileSets.interAffiliateIssuerSummary.data.map((item,index) => (
                                    <React.Fragment>
                                    <tr >
                            ...
                            )):<tr key="1"><td colSpan="12"><p className="text-center text-danger"><FormattedMessage id="There are no InterAffiliate Issuer summary at the moment." defaultMessage="There are no InterAffiliate issuer summary at the moment."/></p></td></tr>
                        ]
                        : [
                            ''
                        ]
...
const mapDispatchToProps= (dispatch) => {
  return bindActionCreators({
    fetchInterAffiliateIssuerSummary
  },dispatch)
}

export default connect(mapStateToProps,mapDispatchToProps)(InterAffiliateIssuerSummary);
