...
import AcquirerSearchForm from '../issuerSearchForm';

import {fetchInterAffiliateIssuerPostingReport} from '../../../../actions/reports';
...
class InterAffiliateAcquirerReport extends Component{
    constructor(props){
        super(props);
        this.state = {
            showModal:false,
    ...
    //    this.props.fetchBatchesSummary('2018-04-12');
        ...
        this.props.fetchInterAffiliateIssuerPostingReport('2018-01-01','2019-12-12',0,'ALL','ALL');
    }
            ...
            <div className="animated fadeIn">
                ...
                <Row>
                    <Col>
                        ...
                        <AcquirerSearchForm {...this.props} {...this.state} onSubmit = {this.onSubmit} onFocusChange={this.onFocusChange}/>
                    </Col>
                ...
                <Row>
                    <Col>
                        <Card>
                        <CardHeader>
                            <i className="fa fa-globe"></i><FormattedMessage id="InterAffiliate Issuer Reports" defaultMessage="InterAffiliate Issuer Reports"/>
                        </CardHeader>
                        <CardBody>
                            {/* {
                            ...
                            <tbody>
                                ...
                                {/* {  this.props.reports.t112PostingReport
                                    ? [
                                        ...
                                        )):<tr><td colSpan="9"><p className="text-center text-danger">There are no reports for today.</p></td></tr>:<tr><td colSpan="9"><p className="text-center text-danger">There are no reports for today.</p></td></tr>
                                    ]
                                    : [
                                        ''
                                    ]
...
const mapStateToProps = (state) => {
  ...
  export default connect(mapStateToProps,mapDispatchToProps)(InterAffiliateAcquirerReport);