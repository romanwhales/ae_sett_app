...
import {fetchInterAffiliateAcquirerSummary,fetchT464Summary,downloadT464PostingFile,fetchInterAffiliateAcquirerSummaryStats} from '../../../../actions/filesets';
...
class InterAffiliateAcquirerSummary extends Component {
    constructor(props){
        super(props);
        this.state ={
            modal:false,
  ...
  componentDidMount(){
    ...
    this.props.fetchInterAffiliateAcquirerSummary(this.props.match.params.date);
    this.props.fetchInterAffiliateAcquirerSummaryStats(this.props.match.params.date);
  }
  ...
  render() {
    ...
    return (
      <div className="animated fadeIn">
        ...
        {this.props.fileSets.interAffiliateAcquirerSummaryStats?<Row>
          <Col>
          <CardGroup className="mb-4">
            <Widget05 icon="icon-people" color="info" header={this.props.fileSets.interAffiliateAcquirerSummaryStats.data.settlementAmount.toLocaleString()} value="25" currencycode={affiliateHTML}>AMOUNT</Widget05>
            <Widget05 icon="icon-user-follow" color="success" header={this.props.fileSets.interAffiliateAcquirerSummaryStats.data.creditCount.toLocaleString()} value="25">CREDITS</Widget05>
            <Widget05 icon="icon-basket-loaded" color="warning" header={this.props.fileSets.interAffiliateAcquirerSummaryStats.data.debitCount.toLocaleString()} value="25">DEBITS</Widget05>
          ...
          <Col lg={12}>
            ...
            <Card>
              ...
              {/* <strong> {this.props.fileSets.fileSetBatchDetail? <React.Fragment> 
                ...
                <strong>
                InterAffiliate Acquirer {this.props.match.params.date} Summary</strong>
                <div className="card-header-actions">
                <a href="" onClick={e => this.downloadPostingFile(this.props.match.params.fileId)} href="javascript:;" download={""+1+".csv"}><i class="fa fa-download" aria-hidden="true" ></i></a>
                </div>
              </CardHeader>
              ...
              <CardBody>
                <Table hover bordered striped responsive size="sm">
                    ...
                    {this.props.fileSets.interAffiliateAcquirerSummary
                        ? [
                            this.props.fileSets.interAffiliateAcquirerSummary.data.length > 0 ?   this.props.fileSets.interAffiliateAcquirerSummary.data.map((item,index) => (
                                    <React.Fragment>
                                    <tr >
...
const mapDispatchToProps= (dispatch) => {
  return bindActionCreators({
    ...
    fetchT464Summary,
    fetchInterAffiliateAcquirerSummary,
    fetchInterAffiliateAcquirerSummaryStats
  },dispatch)
}

export default connect(mapStateToProps,mapDispatchToProps)(InterAffiliateAcquirerSummary);
