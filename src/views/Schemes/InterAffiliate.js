...
class InterAffiliateDashboard extends Component{
    constructor(props){
        super(props);
        this.state = {
            showModal:false,
    ...
    //    this.props.fetchBatchesSummary('2018-04-12');
        ...
        if(date.includes("T")){
         ...
         this.props.fetchSchemeStanding('INTER_AFFILIATE');
            ...
            <div className="animated fadeIn">
                ...
                <Row>
                    <Col>
                        <Card>
                        <CardHeader>
                            <i className="fa fa-credit-card-alt"></i><FormattedMessage id="InterAffiliate Standings" defaultMessage="InterAffiliate Standing"/>
                        </CardHeader>
                        <CardBody>
                            {/* {
...
const mapStateToProps = (state) => {
  ...
  export default connect(mapStateToProps,mapDispatchToProps)(InterAffiliateDashboard);